...
def execute_with_retry(
    ...
    The baseline intentionally carries the timeout budget incorrectly and does
    not protect an ambiguous side effect. Track 1 patches this file in two
    bounded steps and runs public plus hidden checks after each step.
    """
